	...
	<div id="main">
	    ...
	    <div id="content">
               ...
               <div class="postmeta-primary">
					<h2 class="content-heading">Educational Institutes</h2>
					<hr />
				<?php 
				if(!$_REQUEST['education-type']){
					$args = array('taxonomy' => 'education_categories',
							  	  'hide_empty' => 0,
							  	  'order' => 'ASC',
							  	  'parent' => 0);
				...
				?>
									...
									<ul>
										<li>
											<a href="<?php echo $_SERVER['REQUEST_URI'].'?education-type='.$value->slug;?>"> <?php echo $value->name;?></a>
										</li>
									</ul>
				...
				if($_REQUEST['education-type']){
					...
					$interest_category_post = $_REQUEST['education-type'];
					$args = array('post_type' => 'education_post',
								  'numberposts' => -1,
						  		  'posts_per_page' => 5,
						  		  'paged'=> $paged,
						 		);
