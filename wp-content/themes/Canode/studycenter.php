<?php
/*
  Template Name:Study center in motihari

*/


$taxonomy = 'studycenter_categories';
global $theme; get_header(); ?>
	<div id="main">
	    ...
	    <div id="content">
               ...
               <div class="postmeta-primary">
					<h2 class="content-heading"><?php echo ucfirst($_REQUEST['centertype']); ?> Study Center In Motihari</h2>
	<hr />
	<?php 
	if(!$_REQUEST['centertype']){
		$args = array('taxonomy' => 'studycenter_categories',
				  	  'hide_empty' => 0,
				  	  'order' => 'DESC',
				  	  'parent' => 0);
	...
	?>
				<ul>
						<li>
						<a href="<?php echo $_SERVER['REQUEST_URI'].'?centertype='.$value->slug;?>"> <?php echo $value->name;?> </a>
						</li>
				</ul>
<?php
		}
	...
	if($_REQUEST['centertype']){
		...
		$interest_category_post = $_REQUEST['centertype'];
		$args = array('post_type' => 'study-center',
					  'numberposts' => -1,
			  		  'posts_per_page' => 10,
			  		  'paged'=> $paged,
			 		);
