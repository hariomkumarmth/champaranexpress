<?php
/*
  Template Name:hospitals-activity

*/
$taxonomy = 'hospitals_categories';
	...
	<div id="main">
	    ...
	    <div id="content">
               ...
               <div class="postmeta-primary">
					<h2 class="content-heading">Hospitals</h2>
					<hr />
					<?php 
					if(!$_REQUEST['hospital-type']){
						$args = array('taxonomy' => 'hospitals_categories',
								  	  'hide_empty' => 0,
								  	  'order' => 'ASC',
								  	  'parent' => 0);
					...
					?>
								...
								<ul>
									<li><a href="<?php echo $_SERVER['REQUEST_URI'].'?hospital-type='.$value->slug;?>"> <?php echo $value->name;?> </a>
									</li>
								</ul>
					...
					if(	$_REQUEST['hospital-type']){
						$hospitals_category_post = array();
						$hospitals_category_post = $_REQUEST['hospital-type'];
						$args = array('post_type' => 'hopsitals_post',
					  		'numberposts' => -1,
			  		  		'posts_per_page' => 10,
			  		  		'paged'=> $paged,
			 						);
						if(!empty($hospitals_category_post[0])){
						$tax_query = array(array('taxonomy' => $taxonomy,
							 'field' => 'slug',
							 'terms' => $hospitals_category_post
							)
						  );	
