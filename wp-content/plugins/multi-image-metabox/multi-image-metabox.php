...
function add_image_metabox(){
		...
		add_meta_box('imagesliees', __('Add Photos'), "imagesliees",'hopsitals_post', 'normal', 'core');
}
add_action("admin_init", "add_image_metaboxx");
function add_image_metaboxx(){
	
		add_meta_box('imagesliees', __('Add Photos'), "imagesliees",'hotels_post', 'normal', 'core');
}
add_action("admin_init", "add_image_metaboxxx");
function add_image_metaboxxx(){
	
		add_meta_box('imagesliees', __('Add Photos'), "imagesliees",'education_post', 'normal', 'core');
}
add_action("admin_init", "add_image_metaboxxxx");
function add_image_metaboxxxx(){
	
		add_meta_box('imagesliees', __('Add Photos'), "imagesliees",'study-center', 'normal', 'core');
}
/**
B) SAVE METABOX 
*/
